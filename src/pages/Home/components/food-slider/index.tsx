...
export function FoodSlider() {
    return(<Stack display={"flex"} flexDirection={'column'}  alignItems='center' maxWidth={'100%'} gap={4}>
        <Stack width="600px">
            <Typography variant="h3" color="text.primary">
        Nuestro Especiales de esta semana
      </Typography>
      <Button color="secondary" variant="contained" size="small">Menú online</Button></Stack>
